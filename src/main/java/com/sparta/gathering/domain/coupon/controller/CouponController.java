...
@Tag(name = "Coupon", description = "쿠폰 API / 고결")
@RestController
...
public class CouponController {
    ...
    @PostMapping("/request")
    public ResponseEntity<ApiResponse<?>> requestCoupon(@AuthenticationPrincipal AuthenticatedUser authenticatedUser)
    ...
    @GetMapping("/status")
    public ResponseEntity<ApiResponse<?>> getCouponStatus(
